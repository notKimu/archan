...
import { addWhitelistedRole } from "../../utils/db/functions";
...
const command: SlashCommand = {
    ...
    execute: async (interaction) => {
        ...
        whitelistRole ?
          ...
          interaction.reply({ content: "Oops! Is that role already whitelisted? Check it with `/get-badwords`", ephemeral: true })
